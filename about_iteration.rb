...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # array.inject(initial) { |accumulator, element| block }
    # takes initial value, for each element, run code in block, result in each iteration stored in accumulator
  end
  ...
  # The first style is better for file sandwich
  #
